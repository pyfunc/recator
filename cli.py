...
def main():
    ...
    parser.add_argument(
        '-a', '--analyze',
        action='store_true',
        help='Analyze project for duplicates (default action)'
    )
    
    parser.add_argument(
        '-r', '--refactor',
        action='store_true',
        help='Refactor detected duplicates'
    )
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=True,
        help='Preview refactoring without applying changes (default: True)'
    )
    
    parser.add_argument(
        '--apply',
        action='store_true',
        help='Actually apply refactoring changes (use with caution!)'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help='Minimum lines for duplicate detection (default: 4)'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help='Minimum tokens for duplicate detection (default: 30)'
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.85,
        help='Similarity threshold (0-1) for fuzzy matching (default: 0.85)'
    )
    ...
    parser.add_argument(
        ...
        help='Programming languages to analyze (default: python javascript java)'
    )
    
    parser.add_argument(
        '--exclude',
        nargs='+',
        default=['*.min.js', 'node_modules/*', '.git/*'],
